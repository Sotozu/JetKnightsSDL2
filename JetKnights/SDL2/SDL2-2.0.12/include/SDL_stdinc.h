...
#define SDL_IN_BYTECAP(m_x)
#define SDL_INOUT_Z_CAP(m_x)
#define SDL_OUT_Z_CAP(m_x)
#define SDL_OUT_CAP(m_x)
#define SDL_OUT_BYTECAP(m_x)
#define SDL_OUT_Z_BYTECAP(m_x)
